...
/// This method takes a page format and generates the Pdf file data
  ...
  Future<Uint8List> buildPdf(PdfPageFormat format) async {
    ...
    const tableHeaders = ['Fecha','Cant.','Und.','Nombre','V.Und','V.Total'];
        ...
        build: (pw.Context context) {
          return pw.ConstrainedBox(
            ...
            child:pw.Padding(
              ...
              child:pw.Column(
                children:[
                pw.Center(child: pw.Text('AgroLibreta', style: pw.TextStyle(fontSize: 30.0))),
        ...
        build: (pw.Context context) {
          ...
          return pw.Padding(
            ...
            child:pw.Column(
              children:[
                pw.Chart(
                  title: pw.Text('Expense breakdown',style: pw.TextStyle(color: baseColor,fontSize: 20)),
                  grid: pw.PieGrid(),
...
//Future<Uint8List> buildPdf(PdfPageFormat pageFormat)async{//, CustomData data) async {
  ...
  //     build: (pw.Context context) {
        ...
        // return pw.Column(
        //   children: [
        //     pw.Text('Budget Report',style: pw.TextStyle(color: baseColor, fontSize: 40)),
        //     pw.Divider(thickness: 4),
            //pw.Expanded(flex: 3, child: chart1),
            //pw.Divider(),
  ...
  //                   child: pw.Text('Expense By Sub-Categories', style: pw.TextStyle(color: baseColor, fontSize: 16)),
  //                 ),
  //                 pw.Text('Total expenses are broken into different categories for closer look into where the money was spent.',
  ...
  //                       alignment: pw.Alignment.centerLeft,
  //                       padding: const pw.EdgeInsets.only(bottom: 10),
  //                       child: pw.Text('Spent vs. Saved', style: pw.TextStyle(color: baseColor, fontSize: 16)),
  //                     ),
  //                     pw.Text('#####',
