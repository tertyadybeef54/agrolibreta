...
class _RegistrarUsuarioState extends State<RegistrarUsuario> {
  ...
  RegistroUsuariosModel registro = RegistroUsuariosModel();// crear instancia para el modelo de registro a usuarios
  final registroUsuariosProvider = new RegistroUsuariosProvider();// crear instancia para el provider de registro a usuarios
          ...
          Form(
            ...
            child:Column(
              children:<Widget>[
                ...
                Divider(),
                Container(child: _crearPassword(bloc), height:55.0,),
                Divider(),
